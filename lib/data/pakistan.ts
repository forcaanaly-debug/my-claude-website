...
export const pakistanRegions: PakistanRegion[] = [
  ...
  {
    id: 'balochistan',
    name: 'Balochistan — The Forgotten Frontier',
    label: 'Makran Coast, Gwadar, Khuzdar & Quetta',
    cities: ['Karachi', 'Ormara', 'Gwadar', 'Ganz', 'Khuzdar', 'Quetta', 'Ziarat'],
    heroImage: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=1200&q=85',
    description: [
      "Balochistan is Pakistan's largest province and its least visited — a territory the size of France where fewer than fifteen million people live in an ancient and demanding relationship with the desert. It is the land of the Baloch and Brahui peoples, of caravan routes that once connected the Indus Valley to Persia and Mesopotamia, and of a coastline that stretches 750 kilometres along the Arabian Sea.",
      "The Makran Coastal Highway — completed in 2004 — opened one of the world's great coastal drives. The road passes through sculpted mud volcanoes, eroded rock formations, the Princess of Hope arch near Ormara, and the secluded bay of Ganz. Gwadar, at the far end of the drive, sits on a tombolo peninsula being transformed by the China-Pakistan Economic Corridor while its fishing communities continue unchanged.",
      'Inland, Quetta is the provincial capital at 1,680 metres — dried fruit bazaars, Baloch tribal jewellery, and a surrounding mountain desert of austere beauty. A day excursion reaches Ziarat: a juniper hill station where Muhammad Ali Jinnah spent his final weeks before Pakistan\'s independence, the colonial wooden residency preserved as one of the country\'s most poignant heritage sites.',
    ],
    highlights: [
      'Makran Coastal Highway — 750km of Arabian Sea coastline',
      'Kund Malir Beach — white sand and sandstone cliffs',
      'Princess of Hope rock arch, near Ormara',
      'Gwadar — tombolo port city and fishing harbour',
      'Ganz — secluded bay excursion, Baloch fishermen',
      'Moola Chotok canyon — hidden gorge with waterfalls',
      'Quetta bazaars — tribal jewellery, dried fruit, Afghan goods',
      'Ziarat Juniper Forest — trees up to 5,000 years old',
      'Quaid-e-Azam Residency, Ziarat — Jinnah\'s final retreat',
    ],
